#ifndef __COMPARATOR_MCP_H /* COMPARATOR_MCP_H */
#define __COMPARATOR_MCP_H
...
//This preprocessor conditional statement is to avoid unintended linking for unsuppported devices.
	...
	defined (cmp_v2_4) || defined (cmp_v2_5) ||defined (cmp_v2_6) || defined (cmp_v3_1) || defined (LIB_BUILD)
...
#if defined (cmp_v2_4) ||defined (cmp_v2_6)    
...
#if defined (cmp_v2_2) || defined (cmp_v2_3) ||defined (cmp_v2_5) ||defined (cmp_v2_6)|| defined (LIB_BUILD)

#if defined (cmp_v2_6)|| defined (cmp_v3_1) || defined (LIB_BUILD) 
/*****************************************************************************
...
#if defined (cmp_v2_1) || defined (cmp_v2_4) || defined (cmp_v2_6) || defined (cmp_v3_1)
/******************************************************************************
 Macro      : mCMP2_EnblDsbl(state)
 Overview   : Macro Enables/Disables the Comparator 2
 Parameter  : state - *1 Comparator is enabled 
...
/***********************************************************************
Macro      : mCMP3_Clear_Event
Overview   : This macro clears the comparator event bit.
Parameter  : None
Remarks    : This macro clears the comparator event bit.
************************************************************************/ 
#define  mCMP3_Clear_Event            (_C3EVT=0)
