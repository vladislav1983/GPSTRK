...
//This preprocessor conditional statement is to avoid unintended linking for unsupported devices.
#if defined (uart_v1_1) || defined (uart_v1_2) || defined (uart_v1_3) || defined (LIB_BUILD)
